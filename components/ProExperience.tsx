...
import { pro_experiences, type ProExperience } from "@/data/pro_experiences";
import { getIcon } from "@/utils/icons";
import { fadeInUp, staggerContainer } from "@/utils/animations";
import ProExperienceModal from "./ProExperienceModal";

export default function ExperienceComponent() {
  const [selectedExperience, setSelectedExperience] =
    useState<ProExperience | null>(null);
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        >
          {pro_experiences.map((experience) => {
            return (
              <motion.div
                key={experience.id}
                variants={fadeInUp}
